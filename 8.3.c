// Array Implementation of Infix to Postfix Converter (from GeekForGeeks)
...
int infixToPostfix(char *exp)
{
    ...
    for (i=0,k=-1; exp[i]; ++i)
    {
        ...
        // If the scanned chatacter is an ')', pop and output from the stack until an '(' is encountered
        else if (exp[i] == ')')
        {
